...
# 原图片、标签文件、裁剪图片路径
img_path = r'E:\Disease_Classification\dataset\pathlogy_train\rust'
xml_path = r'E:\Disease_Classification\dataset\pathlogy_train\label'
obj_img_path = r'E:\Disease_Classification\dataset\pathlogy_train\cropped'
